        ...
        // comodines
            ...
            // C antidad
                ...
                // ^[ae]?$   a    ^[a-zA-Z]{1,3}@ adfasdf@adsf
                    ...
                    // caracteres
                    // \s -> coincide con una caracter de espacio,entre ellos incluimos espacio,tab,salto de pagina salto de linea,retorno de carro ^[a-zA-z]+\s[a-zA-Z]+$   Dorian Desings  

                    // \S coincide con todos menos caracteres de espacio ^\S(5)$ qwery

                    // \d coindice con un caracter de numero Equivalente a [0-9]    ^\d(5)$  12345

                    // \D  coincide con cualquier caracter no numerico equivalente a [^0-9] ^\D(5)$   asdfg    
                    
                    // \w coindice con cualquier caracter alfanumerico,incluyendo el guion bajo Equivalente a [A-Za-z0-9_] ^\w+@$ 13143_@  

                    // \W coincide con todos menos caracteres de palabras ^\W+$ -.!?%
